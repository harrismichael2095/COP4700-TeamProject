...
<h1>Welcome</h1>
<form method="post">
        <input type="submit" name="admin" class="btn btn-primary"
                value="Become an Admin" style="margin-bottom: 30px;">

        <input type="submit" name="SuperAdmin"  
                value="Become a Super Admin"  class="btn btn-primary" style="margin-bottom: 30px;" >
	   ...
	   <h2><a href="createEvent.php"><strong>Create an Event </strong></a></h2>
	   <h2><a href="map.php"><strong>Google Maps</strong></a></h2>
