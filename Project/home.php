...
if($_SESSION['admin_id'] == -1) {
	...
	<strong>You are not an Admin. Become one to create a RSO and events</strong>
...
// These 2 echoes Tell us UserID and AdminID of the current user. For Testing
...
//Buttons for Admin and Super Admin. Made them for testing purposes.Can delete after.
...
if(isset($_POST['SuperAdmin'])) {
    ...
    if($num==0){
        ...
        $result = mysqli_query($conn, $sql); 
            ...
            echo ' <div class="alert alert-success
			alert-dismissible fade show" role="alert">
			<strong>Success!</strong> Your a Super Admin
			<button type="button" class="close"
				data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true"></span>
			</button>
...
<form method="post">
        <input type="submit" name="admin" class="btn btn-primary text-center" 
                value="Become an Admin" style="margin-bottom: 30px;">

        <input type="submit" name="SuperAdmin"  
                value="Become a Super Admin"  class="btn btn-primary text-center" style="margin-bottom: 30px;" >
